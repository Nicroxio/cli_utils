...
class Back:
    ...
    def Initiate(self):
        ...
        exists = Confirm.ask(
            "Would you like to initiate this backup repo?", default="y"
        )
        if exists:
    ...
    def Backup(self):
        where = Prompt.ask(
            "Where is your backup?", choices=self.config, default=self.config[0]
        )
    ...
    def Restore(self):
        ...
        target = Prompt.ask(
            "Where would you like to restore your backup to?", default="/"
        )
        version = Prompt.ask(
            "Which backup would you like to restore?", default="latest"
        )
...
def main():
    ...
    Selector = Prompt.ask(
        ...
        choices=["Initiate", "Backup", "Restore"],
        default="Backup",
    )
